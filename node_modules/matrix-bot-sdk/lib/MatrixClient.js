...
class MatrixClient extends events_1.EventEmitter {
    ...
    start(filter = null) {
        ...
        return this.getUserId().then((userId) => __awaiter(this, void 0, void 0, function* () {
            ...
            LogService_1.LogService.debug("MatrixClientLite", "Populating joined rooms to avoid excessive join emits");
        ...
        return new Promise((resolve, reject) => {
            ...
            request_1.getRequestFn()(params, (err, response, resBody) => {
                if (err) {
                    ...
                    LogService_1.LogService.debug("MatrixLiteClient (REQ-" + requestId + " RESP-H" + response.statusCode + ")", "<data>");
    ...
    doRequest(method, endpoint, qs = null, body = null, timeout = 60000, raw = false, contentType = "application/json", noEncoding = false) {
        ...
        LogService_1.LogService.info("MatrixLiteClient (REQ-" + requestId + ")", method + " " + url);
        ...
        if (LogService_1.LogService.level.includes(LogService_1.LogLevel.DEBUG)) {
            if (qs)
